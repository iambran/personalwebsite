  ...
  return (
    <Layout>
      ...
      <section className="my">
        ...
        <p>兴趣爱好：摄影，听音乐（有一把martin吉他，但已布满灰尘），爬山，看过无数部美剧（以sitcom/crime为主）。没有微博，没有抖音（相信《娱乐至死》，虽然我还没看过这本书），但后面可能由于工作需要会妥协。朋友圈一个月仅看几回（很多都是点赞之交），尝试并在努力坚持科技极简主义。从事前端工作后，大部分时间花在知乎，b站，slack群，fb群，youtube上面。</p>
